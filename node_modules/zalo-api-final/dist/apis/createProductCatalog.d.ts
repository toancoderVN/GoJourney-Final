...
export declare const createProductCatalogFactory: (ctx: import("../context.js").ContextBase, api: import("../zalo.js").API) => (payload: CreateProductCatalogPayload) => Promise<CreateProductCatalogResponse>;
