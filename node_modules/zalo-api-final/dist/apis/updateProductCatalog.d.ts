...
export declare const updateProductCatalogFactory: (ctx: import("../context.js").ContextBase, api: import("../zalo.js").API) => (payload: UpdateProductCatalogPayload) => Promise<UpdateProductCatalogResponse>;
