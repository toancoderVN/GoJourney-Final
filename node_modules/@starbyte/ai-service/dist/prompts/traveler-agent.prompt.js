 ...
 */
export async function buildTravelerPrompt(bookingContext, conversationHistory, userId, sessionId) {
...
${conversationHistory.map(msg => `${msg.role === 'user' ? '🧑 Agent' : '🏨 Hotel'}: ${msg.content}`).join('\n')}
...
//# sourceMappingURL=traveler-agent.prompt.js.map