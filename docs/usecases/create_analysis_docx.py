...
def create_analysis_docx():
    ...
    font.size = Pt(13) # Standard size for thesis

    # Input file
    md_path = 'docs/usecases/analysis_overview.md'
    ...
    for line in lines:
        ...
        if line.startswith('# '):
            ...
            # Normal Text
            # Handle basic bold parsing **text**
            parts = line.split('**')
            p = doc.add_paragraph()
    ...
    output_path = 'docs/usecases/analysis_overview.docx'
