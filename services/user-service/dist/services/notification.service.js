...
let NotificationService = class NotificationService {
    ...
    async createNotification(userId, type, title, message, data, relatedEntityId) {
    ...
    async markAsRead(notificationId, userId) {
        await this.notificationRepository.update({ id: notificationId, userId }, { status: notification_entity_1.NotificationStatus.READ });
    }
